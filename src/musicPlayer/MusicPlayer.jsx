...
import ImageMask from '../img/Mask Group 23.png';
import Path from '../img/path.png';
import G9 from '../img/Group 9.png';

function MusicPlayer() {
  return (
    <div className='musicPlayer flex flex-col px-5 w-[100%] border-2 border-black 
    py-3 bg-[#232A4E] z-[1] rounded-xl mt-5'>
        <div className='upperPart flex items-center justify-between'>
            <div className='profile flex'>
                ...
                <div className='details flex flex-col ml-4'>
                    <span className='text-[1rem]'>Heal The World</span>
                    <span className='text-sm text-gray-500'>Micheal Jackson</span>
                </div>
            </div>
            <div>
            <img 
